(function (global, factory) {
	...
	(factory((global['ng-selectize'] = global['ng-selectize'] || {}),global.ng.core,global.ng.forms));
...
var SELECTIZE_VALUE_ACCESSOR = {
    ...
    useExisting: _angular_core.forwardRef(function () { return NgSelectizeComponent; }),
    multi: true
};
var NgSelectizeComponent = (function () {
    function NgSelectizeComponent() {
        this.onBlur = new _angular_core.EventEmitter(false);
    ...
    NgSelectizeComponent.propDecorators = {
        'config': [{ type: _angular_core.Input, args: ['config',] },],
        'options': [{ type: _angular_core.Input, args: ['options',] },],
        'optionGroups': [{ type: _angular_core.Input, args: ['optionGroups',] },],
        'placeholder': [{ type: _angular_core.Input, args: ['placeholder',] },],
        'hasOptionsPlaceholder': [{ type: _angular_core.Input, args: ['hasOptionsPlaceholder',] },],
        'noOptionsPlaceholder': [{ type: _angular_core.Input, args: ['noOptionsPlaceholder',] },],
        'enabled': [{ type: _angular_core.Input, args: ['enabled',] },],
        '_value': [{ type: _angular_core.Input, args: ['ngModel',] },],
        'formControl': [{ type: _angular_core.Input },],
        'errorClass': [{ type: _angular_core.Input },],
        'onBlur': [{ type: _angular_core.Output },],
        'selectizeInput': [{ type: _angular_core.ViewChild, args: ['selectizeInput',] },],
    };
...
exports.NgSelectizeModule = NgSelectizeModule;
exports.NgSelectizeComponent = NgSelectizeComponent;
